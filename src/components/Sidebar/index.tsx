                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/exams/take" && "text-white"
                              } `}
                            >
                              Take Exam
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/view-grades"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname.includes("view-grades") && "text-white"
                              }`}
                            >
                              View My Grades
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/calendar"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname.includes("calendar") && "text-white"
                              }`}
                            >
                              Student Calender
                            </Link>
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/exams/upload"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/exams/upload" && "text-white"
                              }`}
                            >
                              Upload Exam
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/exams/upload-marking-scheme"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/exams/upload-marking-scheme" &&
                                "text-white"
                              } `}
                            >
                              Submit Answers
                          ...
                          <li>
                            <Link
                              href="/chart"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname.includes("chart") && "text-white"
                              }`}
                            >
                              Student Performance
                            </Link>
